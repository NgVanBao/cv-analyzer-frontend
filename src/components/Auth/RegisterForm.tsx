  ...
  return (
    <div className="auth-form-container">
      <div className="auth-header">
        <h2>Tạo tài khoản</h2>
        <p>Gia nhập cộng đồng và bắt đầu xây dựng sự nghiệp của bạn.</p>
      </div>
      
      <div className="auth-content">
        <form onSubmit={handleSubmit}>
          <div className="input-group">
            <label className="input-label" htmlFor="name">Họ và Tên</label>
            <input 
              id="name"
              type="text" 
        ...
        <div className="auth-footer">
          Đã có tài khoản? <button type="button" className="auth-link" onClick={onSwitchToLogin}>Đăng nhập</button>
        </div>
      </div>
    </div>
  );
